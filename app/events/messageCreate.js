...
module.exports = {
  ...
  execute(message, client) {
    ...
    if (message.channel.id === '1151133160940261517' && !(message.content.toLowerCase().startsWith('c') || message.content.toLowerCase().startsWith('#credit'))) return message.delete().catch(() => {});
